...
public class chartdetail extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_chartdetail, container, false);
    }
    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Map<String,String>map=new HashMap<>();
        map.put("U_Num",U_Num);
        map.put("BL_Year",this.BL_Year);
        map.put("BL_Mon",this.BL_Mon);
        TextView year=(TextView)getView().findViewById(R.id.detail_year);
        year.setText(this.BL_Year);
        TextView mom=(TextView)getView().findViewById(R.id.detail_mom);
        mom.setText(this.BL_Mon);
                ...
                try {
                    ...
                    if(rlt.equals("false")){
                        ...
                        getActivity().runOnUiThread(()->{
                            ...
                            PieChart pieChart=(PieChart)getView().findViewById(R.id.chart2);
                            pieChart.setData(pieData);
                            pieChart.invalidate();


//                            ListView listview=(ListView)getView().findViewById(R.id.list_report);
//                            CustomList customList=new CustomList(getActivity(),lab,lab2,item);
